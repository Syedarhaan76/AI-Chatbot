...
const API_KEY = "AIzaSyDfAr8sy4bw0BhmusaNSzd5ZfSkOpvNbek";
...
const handleOutgoingMessage = (e) => {
  ...
  //simulates bot response with thinking after delay
  setTimeout(() => {
    ...
    //geneate bot response
    generateBotResponse(incomingMessageDiv);
  }, 600);
};

//Handle Enter key press fro sending messages
